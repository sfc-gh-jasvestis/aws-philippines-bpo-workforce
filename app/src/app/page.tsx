  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Total Headcount" value={kpiVal('Total Headcount', '24,800')} status="neutral" />
        <KPICard title="Attrition Rate" value={kpiVal('Attrition Rate', '4.8%/mo')} status="warning" />
        <KPICard title="Training Completion" value={kpiVal('Training Completion', '92%')} status="neutral" />
        <KPICard title="Open Positions" value={kpiVal('Open Positions', '847')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="Avg Tenure" value={kpiVal('Avg Tenure', '2.4 yrs')} />
        <KPICard title="Promotion Rate" value={kpiVal('Promotion Rate', '12%')} />
        <KPICard title="Engagement Score" value={kpiVal('Engagement Score', '4.1/5')} />
      </div>
      <Chart
